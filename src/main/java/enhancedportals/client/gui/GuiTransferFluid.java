...
public class GuiTransferFluid extends BaseGui
{
    ...
    {
        super.initGui();
        buttonList.add(new GuiButton(1, guiLeft + 7, guiTop + 49, 140, 20, Localization.get("gui." + (fluid.isSending ? "sending" : "receiving"))));
    ...
    {
        super.updateScreen();
        ((GuiButton) buttonList.get(0)).displayString = Localization.get("gui." + (fluid.isSending ? "sending" : "receiving"));
    }
}
