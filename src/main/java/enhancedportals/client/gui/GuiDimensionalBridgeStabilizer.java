...
public class GuiDimensionalBridgeStabilizer extends BaseGui
{
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        getFontRenderer().drawString(Localization.get("gui.activePortals"), 12, 28, 0x777777);
        ...
        if (GeneralUtils.hasEnergyCost())
        {
            ...
            //getFontRenderer().drawString(Localization.get("gui.instability"), 12, 38, 0x777777);
    ...
    public void updateScreen()
    {
        super.updateScreen();
        /*
         * if (GeneralUtils.hasEnergyCost()){ ((GuiButton) buttonList.get(0)).displayString=getPowerStateLocString(); }
         */
    }
}
